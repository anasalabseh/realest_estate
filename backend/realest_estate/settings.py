...
SECRET_KEY = 'django-insecure-yz@ltt%pbo9-v-mo!)9u_zr4s(+lypmho023zs#t1e#f5dxf*&'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'anas.absah@gmail.com'
EMAIL_HOST_PASSWORD = 'yojgrbrilwnksfuw'
EMAIL_USE_TLS = True
...
# Default settings for REST framework 
